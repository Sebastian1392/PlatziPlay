INSERT INTO movies (title, duration, gender, clasification, movie_date, state)
VALUES ('Shrek', 90, 'ANIMADA', 0.0, '2024-06-01', 'D')
    ON CONFLICT (title) DO NOTHING;

INSERT INTO movies (title, duration, gender, clasification, movie_date, state)
VALUES ('Inception', 148, 'CIENCIA_FICCION', 0.0, '2010-07-16', 'D')
    ON CONFLICT (title) DO NOTHING;
...
INSERT INTO movies (title, duration, gender, clasification, movie_date, state)
VALUES ('John Wick', 101, 'ACCION', 0.0, '2014-10-24', 'D')
    ON CONFLICT (title) DO NOTHING;
...
INSERT INTO movies (title, duration, gender, clasification, movie_date, state)
VALUES ('Joker', 122, 'DRAMA', 0.0, '2019-10-04', 'D')
    ON CONFLICT (title) DO NOTHING;
